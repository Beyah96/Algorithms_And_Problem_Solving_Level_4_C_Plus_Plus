...
int main() {
	...
	cout << endl << "Vacation ends : " << endl;
	sDate DateTo = ReadFullDate();
	cout << endl << "Vacation From : " << GetDayName(GetDayOrder(DateFrom)) << ", " << DateFrom.Day << "/" << DateFrom.Month << "/" << DateFrom.Year << endl;
	cout << endl << "Vacation To : " << GetDayName(GetDayOrder(DateTo)) << ", " << DateTo.Day << "/" << DateTo.Month << "/" << DateTo.Year << endl;
