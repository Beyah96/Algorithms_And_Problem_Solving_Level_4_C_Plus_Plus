...
int main() {
	...
	cout << "Today is " << GetDayName(GetDayOrder(DateOne)) << "," << DateOne.Day << "/" << DateOne.Month << "/" << DateOne.Year;
	cout << "Is it end of the week ? " << endl;
	(IsEndOfTheWeek(DateOne)) ? (cout << "Yes, it is end of the week.") : (cout << "No, it is not end of the week.");
	
	cout << endl << "Is it weekend ? " << endl;
	(IsWeekEnd(DateOne)) ? (cout << "Yes, it is weekend.") : (cout << "No, it is not weekend.");
	
	cout << endl << "Is it business day ? " << endl;
	(IsBusinessDay(DateOne)) ? (cout << "Yes, it is business day.") : (cout << "No, it is not business day.");

	cout << endl << endl << "Days until the end of week : " << DaysUntilTheEndOfWeek(DateOne) << " day (s)" << endl;
	cout << "Days until the end of month : " << DaysUntilTheEndOfMonth(DateOne) << " day (s)" << endl;
	cout << "Days until the end of year: " << DaysUntilTheEndOfYear(DateOne) << " day (s)" << endl;
	return 0;
}