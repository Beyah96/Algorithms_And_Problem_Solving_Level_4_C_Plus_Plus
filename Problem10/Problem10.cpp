...
void ConvertBackDate(short CurrentDay, short CurrentMonth, short Year) {
	short NumberOfDays = CountDaysFromFirstJanuary(CurrentDay, CurrentMonth, Year);
	printf("Date for [%d] is :  %d/%d/%d", CurrentDay, CurrentMonth, Year);
}
...
int main() {
	...
	//PrintYearCalender();
	cout << "Number of days from the begining of the year is : " <<  CountDaysFromFirstJanuary (Day, Month, Year) << endl;
	return 0;
}